...
- **Entregable 3.2 — Empleado Digital** · ⬜ Siguiente entregable activo. Contexto Empleados Digitales (`domain-model-v1.md`, §9): la entidad Empleado Digital y su andamiaje auditable (Tarea, Decisión, Escalación, Límite de Autonomía). Pendiente de iniciar su Etapa 1.
