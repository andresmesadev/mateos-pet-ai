...
const RISK_CONFIG = {
  high: {
    label: "Riesgo alto",
    badgeClass: "border-red-300 bg-red-50 text-red-700 dark:border-red-800 dark:bg-red-950 dark:text-red-700",
    barClass: "bg-red-500",
  },
  medium: {
    label: "Riesgo medio",
    badgeClass: "border-amber-300 bg-amber-50 text-amber-700 dark:border-amber-800 dark:bg-amber-950 dark:text-amber-700",
    barClass: "bg-amber-500",
  },
  low: {
    label: "Riesgo bajo",
    badgeClass: "border-yellow-300 bg-yellow-50 text-yellow-700 dark:border-yellow-800 dark:bg-yellow-950 dark:text-yellow-700",
  ...
  return (
    <li className="flex items-center gap-4 px-4 py-3 hover:bg-muted/40 transition-colors">
      ...
      <a
        ...
        className="shrink-0"
      >
        <Button size="sm" variant="outline" className="h-8 text-xs gap-1.5 text-green-700 border-green-300 hover:bg-green-50 dark:text-green-700 dark:border-green-800 dark:hover:bg-green-950">
